### Summary
This paper ShEPhERD: Diffusing shape, electrostatics, and pharmacophores for bioisosteric drug design attempts to grow a new method for ShEPhERD: Diffusing shape, electrostatics, and pha... It is a sturdy root, but one must check the soil for toxins.

### Findings
The authors provide a moderate growth in this area. Citing the use of shape, electrostatics, and pharmacophore... shows some promise. However, the ethical eyes have not yet fully sprouted on the dual-use risks of such powerful harvesting.
